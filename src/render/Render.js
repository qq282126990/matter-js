    ...
    Render.bodies = function (render, bodies, context) {
        ...
        for (i = 0; i < bodies.length; i++) {
          ...
          !options.wireframes
                    ...
                    c.drawImage(
                        texture,
                        (sprite.width || texture.width) * -sprite.xOffset * sprite.xScale,
                        (sprite.height  || texture.height) * -sprite.yOffset * sprite.yScale,
                        sprite.width || texture.width * sprite.xScale,
                        sprite.height || texture.height * sprite.yScale
                    );
        ...
        for (i = 0; i < pairs.length; i++) {
            ...
            if (pair.contactCount > 0) {
                ...
                if (pair.contactCount === 2) {
                    normalPosX =
            (pair.contacts[0].vertex.x + pair.contacts[1].vertex.x) / 2;
                    normalPosY =
            (pair.contacts[0].vertex.y + pair.contacts[1].vertex.y) / 2;
                }
